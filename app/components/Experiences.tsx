          ...
          {experiences.map((experience, index) => (
            <ScrollReveal key={index} delay={index * 100}>
              <div className="group relative rounded-3xl overflow-hidden aspect-[4/5] shadow-lg hover:shadow-2xl transition-all duration-500 cursor-pointer">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/30 to-black/10 transition-opacity duration-500 group-hover:opacity-90"></div>
                ...
                <div className="absolute inset-0 p-6 sm:p-8 flex flex-col justify-end text-white z-10">
                  <div className="transform transition-transform duration-500 lg:translate-y-12 lg:group-hover:translate-y-0">
                    <h4 className="text-2xl font-bold mb-3 drop-shadow-md">{experience.title}</h4>
                    <div className="w-12 h-1 bg-[var(--color-brand-orange)] mb-4 rounded-full transition-all duration-500 group-hover:w-full"></div>
