          ...
          >
            <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-start md:items-end justify-between gap-10">
              ...
              <div className="flex flex-col sm:flex-row gap-4 w-full md:w-auto shrink-0">
                <a href={heroContent.primaryButtonLink} className="bg-brand-gradient px-8 py-4 rounded-full font-bold text-lg shadow-xl text-center flex items-center justify-center gap-2 group">
